...
import { setIdActive, setIsOpenDrawer } from "../common/policy.slice";

type Props = { appPolicy: IAppPolicy };

export default function PolicyItem({ appPolicy }: Props) {
  const dispatch = useDispatch();
  const { idActive } = useSelector((state: RootState) => state.policy);
